            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="firstName" className="block text-sm font-medium leading-6 text-zinc-300 font-mono">
                                Ad
                            </label>
                            <div className="mt-2">
                                <input
                        ...
                        <div>
                            <label htmlFor="lastName" className="block text-sm font-medium leading-6 text-zinc-300 font-mono">
                                Soyad
                            </label>
                            <div className="mt-2">
                                <input
                    ...
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium leading-6 text-zinc-300 font-mono">
                            Email Adresi
                        </label>
                        <div className="mt-2">
                            <input
                    ...
                    <div>
                        <label htmlFor="password" className="block text-sm font-medium leading-6 text-zinc-300 font-mono">
                    ...
                    <div>
                        <label htmlFor="role" className="block text-sm font-medium leading-6 text-zinc-300 font-mono">
                            Rol
                        </label>
                        <div className="mt-2">
                            <select
                                ...
                                value={formData.role}
                                onChange={handleChange}
                                className="block w-full rounded-md border-0 bg-zinc-900 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 px-3 font-mono"
                            >
