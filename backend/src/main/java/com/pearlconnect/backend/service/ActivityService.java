...
public class ActivityService {
    ...
    public List<ActivityResponse> getPendingActivitiesForSchool(Long schoolId) {
        return activityRepository.findByStudentSchoolIdAndStatusOrderByCreatedAtAsc(schoolId, ActivityStatus.PENDING).stream()
                .map(this::mapToDto)
                .collect(Collectors.toList());
    }
    ...
    public ActivityResponse approveActivity(Long activityId, Long approverId) {
        ...
        // Add hours to student's total hours
        User student = activity.getStudent();
        student.setTotalHours(student.getTotalHours() + activity.getHours());
    ...
    private ActivityResponse mapToDto(Activity activity) {
        return ActivityResponse.builder()
                ...
                .studentName(activity.getStudent().getFirstName() + " " + activity.getStudent().getLastName())
                .approverId(activity.getApprover() != null ? activity.getApprover().getId() : null)
                .approverName(activity.getApprover() != null ? activity.getApprover().getFirstName() + " " + activity.getApprover().getLastName() : null)
